        ...
        this.observeHandle = this.cursor.observe({
            added: Meteor.bindEnvironment((doc) => {
                ...
                if (alreadyPublished) {
                    ...
                    this.subscription.changed(collectionName, doc._id, this.projectionFn(doc));
                } else {
            ...
            changed: Meteor.bindEnvironment((newDoc, oldDoc) => {
                ...
                projectedNew = this.projectionFn(newDoc);
                projectedOld = this.projectionFn(oldDoc);
                changedFields = _makeChangedFields(projectedNew, projectedOld);
